...
declare module IQ.Color {
    ...
    class DistanceCIEDE2000_Original implements IDistanceCalculator {
        ...
        private static _degrees2radians(n);
        setMaximalColorDeltas(maxRedDelta: number, maxGreenDelta: number, maxBlueDelta: number, maxAlphaDelta: number): void;
        calculateRaw(r1: number, g1: number, b1: number, a1: number, r2: number, g2: number, b2: number, a2: number): number;
...
declare module IQ.Image {
    ...
    class DitherErrorDiffusion implements IImageDitherer {
        ...
        private _distance;
        constructor(colorDistanceCalculator: Color.IDistanceCalculator, kernel: DitherErrorDiffusionKernel, serpentine?: boolean, minimumColorDistanceToDither?: number, calculateErrorLikeGIMP?: boolean);
        quantize(pointBuffer: Utils.PointContainer, palette: Utils.Palette): Utils.PointContainer;
...
declare module IQ.Palette {
    class NeuQuant implements IPaletteQuantizer {
        ...
        private static _netbiasshift;
        private static _ncycles;
        private static _intbiasshift;
        private static _intbias;
